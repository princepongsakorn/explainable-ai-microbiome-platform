...
os.environ['MLFLOW_TRACKING_PASSWORD'] = "bzh12bhcE8uPzhgDuzXxGo6ys2PXcqvoHkLHL0dV"

mlflow.set_tracking_uri("http://ec2-3-1-102-14.ap-southeast-1.compute.amazonaws.com:5000")
mlflow.set_experiment("rf-crc-e2e")
...
def objective(params):
    with mlflow.start_run() as run:
        ...
        mlflow.sklearn.log_model( 
            ...
            registered_model_name="sample-randomforest-crc",
