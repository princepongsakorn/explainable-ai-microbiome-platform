...
// The pressed state is the primary colour, not shadcn's accent: accent is the
// same pale grey as hover, so a pressed filter looked like every other one.
// Hover on a pressed item is set explicitly so the outline variant's hover
// cannot wash it back to grey.
